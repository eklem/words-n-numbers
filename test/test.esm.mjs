...
import { extract, words, numbers, emojis, emojisCustom, tags, usernames, email } from '../dist/words-n-numbers.esm.mjs'
...
test('extract emojis with custom emoji extraction', t => {
  const oldString = 'A ticket to 大阪 costs ¥2000 👌😄😄 😢👩🏽‍🤝‍👨🏻 👩🏽‍🤝‍👨🏻'
  const newArray = extract(oldString, { regex: emojisCustom, flags: 'g' })
  t.deepEqual(newArray, ['👌', '😄', '😄', '😢', '👩🏽‍🤝‍👨🏻', '👩🏽‍🤝‍👨🏻'])
})
